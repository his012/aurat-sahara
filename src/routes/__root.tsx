...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Aurat Sahara" },
      { name: "description", content: "Aurat-Sahara configures a project for managing user applications and certificates." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Aurat Sahara" },
      { property: "og:description", content: "Aurat-Sahara configures a project for managing user applications and certificates." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Aurat Sahara" },
      { name: "twitter:description", content: "Aurat-Sahara configures a project for managing user applications and certificates." },
